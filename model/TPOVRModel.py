...
class TPOVRModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        # self.loss_names = ['img_rec', 'img_G', 'img_D', 'lab_s', 's_rec', 'lab_t']
        self.loss_names = ['img_rec', 'img_G', 'img_D', 'lab_s', 'lab_t']
    ...
    def backward_translated2flow(self):
        ...
        # print('Aashish')
        self.loss_lab_t = multiloss.realEPE(flow_t, self.lab_t, sparse = True)
