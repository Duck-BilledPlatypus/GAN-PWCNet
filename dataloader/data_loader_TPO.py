...
class CreateDataset(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        if self.opt.isTrain:
            ...
            lab_h, lab_w = lab_source.shape[0], lab_source.shape[1]
            ...
            lab_source[0] = lab_source[0] * self.opt.loadSize[0] / lab_w
            lab_source[1] = lab_source[1] * self.opt.loadSize[1] / lab_h
